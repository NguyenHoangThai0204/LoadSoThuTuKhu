...
//                // không có bệnh nhân
//                roomHtml += `<tr><td colspan="3" class="text-center text-muted">Không có bệnh nhân</td></tr>`;
//            } else {
//                displayedPatients.slice(0, limit).forEach(patient => {
...
//        //roomContainer.innerHTML = roomHtml || `<div class="col-12 text-center py-5">Không có dữ liệu hiển thị</div>`;
...
//                inputId: "searchPhong", // Đổi thành searchKhu nếu cần
