...
namespace LoadSoThuTuKhu.Models.M0302
{
    public class Context0302 : DbContext
    {
        ...
        public DbSet<M0302LoadSoThuTuKhuModel> LoadSoThuTuKhuModels { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<M0302LoadSoThuTuKhuModel>().HasNoKey();
        }
